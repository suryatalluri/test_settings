...
import com.test_settings.t4375.service.Table2Service;
 ...
 * @see com.test_settings.t4375.Table2
 */

@RestController(value = "T4375.Table2Controller")
@Api(value = "/t4375/Table2", description = "Exposes APIs to work with Table2 resource.")
@RequestMapping("/t4375/Table2")
public class Table2Controller {

    private static final Logger LOGGER = LoggerFactory.getLogger(Table2Controller.class);

	@Autowired
	@Qualifier("t4375.Table2Service")
	...
	public Table2 getTable2( @RequestParam("column2") Integer column2, @RequestParam("id") Integer id)
