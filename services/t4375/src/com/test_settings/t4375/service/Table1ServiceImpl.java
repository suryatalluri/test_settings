...
public class Table1ServiceImpl implements Table1Service {
    ...
    public void setWMGenericDao(WMGenericDao<Table1, Table1Id> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "t4375TransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "t4375TransactionManager")
    @Override
