 ...
 */
@Service("test_procedure.EmployeeService")
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Autowired
    @Qualifier("test_procedure.EmployeeDao")
    ...
    public void setWMGenericDao(WMGenericDao<Employee, Integer> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "test_procedureTransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "test_procedureTransactionManager")
    @Override
